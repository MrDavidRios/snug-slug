...
export const ListingCreationPage: React.FC = () => {
  ...
  // apartmentType
  const [apartmentType, setApartmentTypeOptions] = useState<String[]>(); 
  ...
  const handleApartmentTypeChange = (selectedOption: string) => {
    setApartmentTypeOptions(selectedOption);
  };
  ...
  const interviewOptions = ["Interview and Background Check Required", "Background Check Required", "Interview Required", "Other Verification Required","No Background Check and Interview Required"]; 
  ...
  const genderOptions = ["No Preference for Gender", "Women and Gender Diverse Only", "Women Only", "Men Only", "Other"]; 
  ...
  const handleOtherPreferencesChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    setOtherPreferences(e.target.value);
  };
    
  // pet 
  const [pet, setPet] = useState("");
  const petOptions = ["Sorry, no pets allowed.", "Pets are welcome!", "Depends - let's discuss on a case-by-case basis."]; 
  ...
  const gymOptions = ["There's a full gym in-building!", "There's limited fitness facilities in-building", "There's no gym in the building."]; 
  ...
  const hanldeOtherAmenitites = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    <div id="overall">
      ...
      <div id="section">
        ...
        <DatePickerDropdown
          ...
          placeholderText="Select Date Availabiity "
          onChange={(e) => {
      ...
      <div id="section">
        ...
        <div id="mediaSection">
          <div id="image"> <em>Bedroom</em> </div>
          <div id="image"> <em>Living Space</em> </div>
          <div id="image"> <em>Bathroom</em></div>

        </div>
      
      </div>

      <Button onClick={handleSearch} text="All done! Share my listing." style={{marginTop: "10px", backgroundColor: 'lightblue'}} />
